...
- Node.js + npm
- Docker
- **AuthLuiz em execução** — o PermissoesLuiz valida JWTs via JWKS do AuthLuiz
...
Use o repositório **luiz-stack** (`github.com/luizotavionazar/luiz-stack`) para subir AuthLuiz + PermissoesLuiz juntos com um único `docker compose up`.
