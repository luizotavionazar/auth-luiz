# PermissoesLuiz — Frontend

Implementação de referência em Vue 3 + Vite para a API de autorização PermissoesLuiz. O login é feito diretamente no AuthLuiz; o JWT obtido é usado aqui para acessar os endpoints de roles e permissões.
...
├── services/
│   ├── api.js                    Instância Axios apontando para o PermissoesLuiz (:8081)
...
- O login é feito **diretamente no AuthLuiz** — o PermissoesLuiz não emite tokens; apenas os valida.
